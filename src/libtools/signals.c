...
static int should_throttle_unity_signal(int sig)
{
    ...
    long time_diff_ms = (current_time.tv_sec - last_sigxcpu_time.tv_sec) * 1000 + (current_time.tv_nsec - last_sigxcpu_time.tv_nsec) / 1000000;
