...
{
    return SCRATCH0 + dyn->v.fpu_scratch++;
}
...
{
    // TODO
    (void)dyn; (void)ninst; (void)max_ninst_reached;
}

void tryEarlyFpuBarrier(dynarec_ppc64le_t* dyn, int last_fpu_used, int ninst)
{
    // TODO
    (void)dyn; (void)last_fpu_used; (void)ninst;
}
