...
#define PROT_NEVERCLEAN_LARGEPAGE   0x200   // NEVERCLEAN due to large host page mixing code+data (safe to cache with countdown)
#define PROT_DYNAREC    0x80
#define PROT_DYNAREC_R  0x40
#define PROT_NOPROT     0x20
#define PROT_DYN        (PROT_DYNAREC | PROT_DYNAREC_R | PROT_NOPROT | PROT_NEVERCLEAN | PROT_NEVERCLEAN_LARGEPAGE)
#define PROT_CUSTOM     (PROT_DYNAREC | PROT_DYNAREC_R | PROT_NOPROT | PROT_NEVERCLEAN | PROT_NEVERCLEAN_LARGEPAGE)
